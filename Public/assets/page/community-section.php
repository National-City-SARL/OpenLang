<!--
    /**
    * copyright 2024 @Community iup_dev
    */
-->
<!DOCTYPE html>
        ...
        <main>
          ...
          <div class="container py-4">
            ...
            <div class="row align-items-md-stretch">
              <div class="col-md-4 mb-4">
                <div class="h-100 p-5 bg-dark rounded-3 ">
                  <img src="../picture/contributing.svg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="230px" height="230px" loading="lazy"><br>
                </div>
              </div>
              <div class="col-md-8 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3">
                  <h2 class="display-5 fw-bold">Community OpenLang</h2>
                  <p class="col-md-8 fs-4">
                    Bienvenue dans la version community de OpenLang nous sommes heureux de vous accueillir sur notre application.</p>
                    <a href="https://openlang.my.canva.site/documentation" target="_blank" class="btn btn-outline-light text-warning">Github community</a>
                </div>
              </div>
            </div>
            ...
            <div class="row align-items-md-stretch">
              <div class="col-md-8 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3">
                  <h2 class="display-5 fw-bold">Contribution</h2>
                  <p class="col-md-8 fs-4">
                    Nous sommes ensemble pour mieux construire.</p>
                    <a href="https://openlang.my.canva.site/documentation" target="_blank" class="btn btn-outline-light text-info">Ma contribution</a>
                </div>
              </div>
              <div class="col-md-4 mb-4">
                <div class="h-100 p-5 bg-dark rounded-3 ">
                  <img src="../picture/folder-mjml.svg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="200px" height="200px" loading="lazy"><br>
                </div>
              </div>
            </div>
          </div>
