<!--
    ...
    */
-->
<!DOCTYPE html> <!-- @Community iup_dev -->
          ...
          <div class="container py-4">
            ...
            <div class="row align-items-md-stretch">
              <div class="col-md-4 mb-4">
                <div class="h-100 p-5 bg-dark rounded-3 ">
                  <img src="../picture/user.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="200px" height="200px" loading="lazy"><br>
                </div>
              </div>
              <div class="col-md-8 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3">
                  <h2 class="display-5 fw-bold">Crée un Compte</h2>
                  <p class="col-md-8 fs-4">
                    Le compte permet à l’utilisateur d’accéder aux fonctionnalités du logiciel en ligne et de récupérer des paramètres et des données..</p>
                    <a href="https://openlang.my.canva.site/documentation" target="_blank" class="btn btn-outline-light">Crée un Compte</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-md-stretch mt-3">
              <div class="col-md-12 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3 ">
                  <h2 class="display-5 fw-bold">Sécurité sur votre système</h2>
                  <p class="col-md-8 fs-5">
                  Avec la croissance de la technologie ces dernières années, être en sécurité sur votre système est le numéro un. De même, la préservation et la sécurité du matériel informatique sont également de la plus haute importance.</p>
                </div>
              </div>
            </div>
