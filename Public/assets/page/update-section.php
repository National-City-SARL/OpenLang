          ...
          <div class="container py-4">
            ...
            <div class="row align-items-md-stretch">
              <div class="col-md-4 mb-4">
                <div class="h-100 p-5 bg-dark rounded-3 ">
                  <img src="../picture/picture-svg/folder-custom.svg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="230px" height="230px" loading="lazy"><br>
                </div>
              </div>
              <div class="col-md-8 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3">
                  <h2 class="display-5 fw-bold">Mise a jour</h2>
                  <p class="col-md-8 fs-4">
                    Si vous êtes bon en rédaction, vous pouvez aider à écrire de la documentation pour le logiciel.</p>
                    <a href="https://openlang.my.canva.site/documentation" target="_blank" class="btn btn-outline-light text-info">Voir Mise a jour</a>
                </div>
              </div>
            </div>
            ...
            <div class="row align-items-md-stretch mt-3">
              <div class="col-md-12 mb-4">
                <div class="h-100 p-5 text-white bg-dark rounded-3 ">
                  <h2 class="display-5 fw-bold">Aide OpenLang</h2>
                  <p class="col-md-8 fs-5">
                    Essayez notre version community dès aujourd’hui et découvrez pourquoi tant de personnes choisissent
                    OpenLang !</p>
                  <a href="https://openlang.my.canva.site/documentation" target="_blank" class="btn btn-outline-light">www.OpenLang.Com</a>
                </div>
              </div>
            </div>
          </div>
